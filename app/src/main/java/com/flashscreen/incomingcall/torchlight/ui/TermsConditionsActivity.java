...
import com.flashscreen.incomingcall.torchlight.databinding.ActivityTermsConditionsBinding;
...
public class TermsConditionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String termsConditions = "Posting rules you should be taking care of before you start interaction on our website/application:\n" +
                ...
                "\n If anyone or any account is spotted doing the above restricted activities they can be booked and arrested for the same. If viewers spot any violations of the above rules they have the right to report the content to us by using the report feature given in our Flashlight LED Torch light.\n" +
                "\n" +
                "\n";
