...
import com.flashscreen.incomingcall.torchlight.databinding.ActivityGuide1Binding;
import com.flashscreen.incomingcall.torchlight.databinding.ActivityGuide2Binding;
...
public class Guide2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGuide2Binding.inflate(getLayoutInflater());
        ...
        AdUtils.showNativeAd(activity, Constants.adsResponseModel.getNative_ads().getAdx(), binding.smallNative.findViewById(com.adsmodule.api.R.id.native_ad), 2, null);
