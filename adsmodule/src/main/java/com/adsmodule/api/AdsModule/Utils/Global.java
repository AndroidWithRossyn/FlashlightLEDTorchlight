...
public class Global {
    ...
    public static void showUpdateAppDialog(Activity activity) {
        ...
        updateDialog.findViewById(R.id.tv_install).setOnClickListener(view -> {
    ...
    public static void showAlertProgressDialog(Activity activity) {
        if (!activity.getComponentName().getClassName().equals("com.flashscreen.incomingcall.torchlight.ui.SplashActivity")) {
